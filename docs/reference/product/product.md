...
- **Replay analysis** that uses bounded corridor search to explain the final
  setup corridor, show the last visible escape, and mark why alternate replies
  still collapse before lethal onset.
