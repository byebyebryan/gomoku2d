...
Active tuning and screenshot-review notes remain under [`working/`](working/).
The completed `v0.5.4` plan and finding register live in [`archive/`](archive/)
with the other historical release material.
