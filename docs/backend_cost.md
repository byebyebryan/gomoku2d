...
| Firebase Auth | Initialized as Identity Platform; Google provider pending Web OAuth client | Billing is enabled; stay inside no-cost MAU tier and avoid phone/SAML/OIDC |
