...
pub static SCENARIOS: &[BenchScenario] = &[
    ...
    BenchScenario {
        ...
        variant: Variant::Freestyle,
        to_move: Color::Black,
        tags: &["tactical", "shape", "offense", "open-four", "freestyle"],
    ...
    BenchScenario {
        ...
        variant: Variant::Freestyle,
        to_move: Color::White,
        tags: &["tactical", "shape", "defense", "open-four", "freestyle"],
        description: "White can occupy either completion square of Black's open four.",
        probe_move: "G8",
        moves: &["H8", "A1", "I8", "C1", "J8", "E1", "K8"],
    },
    BenchScenario {
        id: "shape_offense_closed_four",
        variant: Variant::Freestyle,
        to_move: Color::Black,
        tags: &["tactical", "shape", "offense", "closed-four", "freestyle"],
    ...
    BenchScenario {
        ...
        variant: Variant::Freestyle,
        to_move: Color::White,
        tags: &["tactical", "shape", "defense", "closed-four", "freestyle"],
        description: "White can answer the only completion square of Black's closed four.",
        probe_move: "L8",
        moves: &["H8", "G8", "I8", "A1", "J8", "C1", "K8"],
    },
    BenchScenario {
        id: "shape_offense_broken_four",
        variant: Variant::Freestyle,
        to_move: Color::Black,
        tags: &["tactical", "shape", "offense", "broken-four", "freestyle"],
    ...
    BenchScenario {
        ...
        variant: Variant::Freestyle,
        to_move: Color::White,
        tags: &["tactical", "shape", "defense", "broken-four", "freestyle"],
    ...
    BenchScenario {
        ...
        variant: Variant::Freestyle,
        to_move: Color::Black,
        tags: &["tactical", "shape", "offense", "open-three", "freestyle"],
    ...
    BenchScenario {
        ...
        variant: Variant::Freestyle,
        to_move: Color::White,
        tags: &["tactical", "shape", "defense", "open-three", "freestyle"],
        description: "White can occupy either extension square of Black's open three.",
        probe_move: "G8",
    ...
    BenchScenario {
        ...
        variant: Variant::Freestyle,
        to_move: Color::Black,
        tags: &["tactical", "shape", "offense", "closed-three", "freestyle"],
    ...
    BenchScenario {
        ...
        variant: Variant::Freestyle,
        to_move: Color::White,
        tags: &["tactical", "shape", "defense", "closed-three", "freestyle"],
        description: "White can occupy the only extension square of Black's closed three.",
        probe_move: "K8",
    ...
    BenchScenario {
        ...
        variant: Variant::Freestyle,
        to_move: Color::Black,
        tags: &["tactical", "shape", "offense", "broken-three", "freestyle"],
    ...
    BenchScenario {
        ...
        variant: Variant::Freestyle,
        to_move: Color::White,
        tags: &["tactical", "shape", "defense", "broken-three", "freestyle"],
        description: "White can occupy the rest square of Black's broken three.",
        probe_move: "I8",
